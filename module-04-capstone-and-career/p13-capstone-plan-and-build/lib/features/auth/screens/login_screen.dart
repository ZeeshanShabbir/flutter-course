...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  final _passCtrl = TextEditingController(text: 'Flutter123');
  bool _obscure = true;
  ...
  Future<void> _signIn() async {
    ...
    await ref.read(authProvider.notifier).signIn(_emailCtrl.text.trim(), _passCtrl.text);
  }
            ...
            child: Form(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                Container(width: 72, height: 72,
                  ...
                  child: const Icon(Icons.task_alt, size: 40, color: AppTheme.primary)),
                const SizedBox(height: 24),
                const Text('Welcome Back', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                const SizedBox(height: 4),
                const Text('Capstone — D4WEE Flutter Course', textAlign: TextAlign.center,
                ...
                TextFormField(controller: _passCtrl, obscureText: _obscure, onFieldSubmitted: (_) => _signIn(),
                ...
                ElevatedButton(onPressed: auth.isLoading ? null : _signIn,
                  child: auth.isLoading ? const SizedBox(height: 22, width: 22,
                    child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                    : const Text('Sign In')),
                const SizedBox(height: 12),
                TextButton(onPressed: () => context.push(Routes.register),
